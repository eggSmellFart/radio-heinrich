...
Teilbereiche des Herzens beziehungsweise bei folgenden Fragen:';
	...
	// vu für voruntersuchung

	$vu_h3 = 'Vor der Untersuchung';
	$vu_icon1 = 'https://via.placeholder.com/150';
	$vu_icon2 = 'https://via.placeholder.com/150';
	$vu_icon3 = 'https://via.placeholder.com/150';
	$vu_icon4 = 'https://via.placeholder.com/150';
	$vu_h3_container_left = 'Vorbereitung';
	$vu_h3_container_right = 'Voruntersuchungen';
	$vu_text_container_left = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi impedit culpa minus nesciunt voluptatibus doloremque similique itaque quae ab reiciendis, quaerat temporibus, suscipit, laudantium sapiente! Sed eaque eligendi commodi magnam.';
	$vu_text_container_right = 'Itaque quae ab reiciendis, quaerat temporibus, suscipit, laudantium sapiente! Sed eaque eligendi commodi magnam. Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi impedit culpa minus nesciunt voluptatibus doloremque similique';

	$tab_bottom_text_header_left =  'Kontradiktionen';
	$tab_bottom_text_header_right = 'Kostenübernahme';
	$tab_bottom_text_left = 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum, reiciendis harum! Consequuntur repellat excepturi architecto autem odit vel voluptatibus modi, voluptatem hic eveniet consequatur voluptas laboriosam, officiis sequi! Quo, vel!Ducimus unde enim, veniam neque natus est nesciunt asperiores esse, corporis ipsum vitae, dolore ex laudantium veritatis. Praesentium similique, tenetur cum id explicabo libero ipsam quo repellat repudiandae et! Dolore?'; 
	$tab_bottom_text_right = 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident autem numquam consequatur nulla omnis error, harum doloribus, eveniet nam enim rem optio libero officia dolor laboriosam veritatis fugiat labore repudiandae.Qui porro aut nesciunt numquam velit ullam unde. Eius, at! Veritatis, quaerat officiis aperiam sunt, qui magnam modi, delectus atque facilis quod architecto dolores aliquid molestias recusandae numquam aut. Neque.'; 
...
<section id="herzdiagnostik" class="subpage tab-pane fade show active row row-cols-1" role="tabpanel" aria-labelledby="herzdiagnostik-tab">
	<div class="container col"  data-parallax="scroll" data-image-src="images/terminvergabe.png">
		<div class="row ">
			<div class="container col-12 " >
				<div class="col-12 container parallax-window" data-natural-height="350" >
					<!-- leave empty -->
				</div>
				<div class="kompetenzen-parallax">
									...
									<div class="row">
										<div class="container col-12">
											<div class="termin-sidebar">
												...
												<a class="phone_number" href="tel:+49241946950">
													<?php echo $termin_phone; ?>												</a>
												<br>
												<br>
												<p>
							...
							<div class="container col-12">
								<div class="row">
									<div class="container col-8">
										<div class="row">
											<div class="container col-8">
												<h3><?php echo $vu_h3; ?></h3>
												<div class="row">
													<div class="container col-6">
														<div class="row no-gutters voruntersuchung_container">
															<div class="container col-12">
																<div class="row no-gutters icon_container">
																	<div class="container col-4">
																		<img src="<?php echo $vu_icon1; ?>" alt="">
																	</div>
																	<div class="container col-4"><!-- leave empty --></div>
																	<div class="container col-4"><!-- leave empty --></div>
																</div>
																<div class="row">
																	<div class="container col-12">
																		<h3><?php echo $vu_h3_container_left; ?></h3>
																		<p><?php echo $vu_text_container_left; ?></p>
																	</div>
																</div>
															</div>
														</div>	
													...
													<div class="container col-6">
														<div class="row no-gutters voruntersuchung_container">
															<div class="container col-12">
																<div class="row no-gutters icon_container">
																	<div class="container col-4">
																		<img src="<?php echo $vu_icon2; ?>" alt="">
																	</div>
																	<div class="container col-4">
																		<img src="<?php echo $vu_icon3; ?>" alt="">
																	</div>
																	<div class="container col-4">
																		<img src="<?php echo $vu_icon4; ?>" alt="">
																	</div>
																	
																</div>
																<div class="row">
																	<div class="col-12 container">
																		<h3><?php echo $vu_h3_container_right; ?></h3>
																		<p><?php echo $vu_text_container_right; ?></p>
																	</div>
																</div>
															</div>
														</div>
						...
						<div class="row">
							<div class="container col-12">
								<div class="row">
									<div class="container col-8">
										<div class="row">
											<div class="container col-8 tab_bottom_text_block">
												<div class="row">
													<div class="container col-6">
														<h3><?php echo $tab_bottom_text_header_left; ?></h3>
														<p><?php echo $tab_bottom_text_left; ?></p>
													</div>
													<div class="container col-6">
														<h3><?php echo $tab_bottom_text_header_right; ?></h3>
														<p><?php echo $tab_bottom_text_right; ?></p>
													</div>
